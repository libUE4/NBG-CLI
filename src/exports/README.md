...
The NBG extension exposes a compatibility API that can be used by other extensions. To use this API in your extension:
...
3. Get access to the API with the following code:
    ...
    if (!clineExtension?.isActive) {
        throw new Error("NBG extension is not activated")
    }
    ...
    if (cline) {
        ...
        await cline.startNewTask("Hello, NBG! Let's make a new project...")
        ...
        console.error("NBG API is not available")
    }
    ```
