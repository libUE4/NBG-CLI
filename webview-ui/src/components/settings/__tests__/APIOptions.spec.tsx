...
describe("ApiOptions Component", () => {
	...
	it("renders Together Model ID input", () => {
		...
		const modelIdInput = screen.getByPlaceholderText("输入模型 ID...")
		expect(modelIdInput).toBeInTheDocument()
	})
})
...
describe("ApiOptions Component", () => {
	...
	it("renders Fireworks Model Select", () => {
		...
		const modelIdSelect = screen.getByLabelText("模型")
...
describe("OpenApiInfoOptions", () => {
	...
	it("renders OpenAI Supports Images input", () => {
		...
		const apiKeyInput = screen.getByText("支持图片")
		expect(apiKeyInput).toBeInTheDocument()
	})
	...
	it("renders OpenAI Context Window Size input", () => {
		...
		fireEvent.click(screen.getByText("模型配置"))
		const orgIdInput = screen.getByText("上下文窗口大小")
	...
	it("renders OpenAI Max Output Tokens input", () => {
		...
		fireEvent.click(screen.getByText("模型配置"))
		const modelInput = screen.getByText("最大输出 Token")
