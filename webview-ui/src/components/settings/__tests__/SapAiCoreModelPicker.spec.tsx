...
describe("SapAiCoreModelPicker Component", () => {
	...
	it("renders with default placeholder", () => {
		...
		const placeholderOption = screen.getByText("选择模型...")
	...
	it("renders with custom placeholder", () => {
		...
		const placeholderOption = screen.getByText("选择 SAP AI Core 模型...")
		expect(placeholderOption).toBeInTheDocument()
	})
	...
	it("shows deployed models section when deployed models exist", () => {
		...
		const deployedHeader = screen.getByText("── 已部署模型 ──")
	...
	it("shows not deployed models section when supported but not deployed models exist", () => {
		...
		const notDeployedHeader = screen.getByText("── 未部署模型 ──")
	...
	it("handles empty deployed models array", () => {
		...
		expect(screen.queryByText("── 已部署模型 ──")).not.toBeInTheDocument()
	...
	it("handles case where all supported models are deployed", () => {
		...
		expect(screen.queryByText("── 未部署模型 ──")).not.toBeInTheDocument()
