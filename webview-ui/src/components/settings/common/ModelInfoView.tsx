				...
				<AdvancedSection>
					...
					{hasTiers && (
						<div style={{ marginTop: 8 }}>
							<div style={{ fontWeight: 500, marginBottom: 4 }}>分级价格：</div>
							{modelInfo.tiers && (
								<>
									<div>
					...
					{showProviderRouting && onProviderSortingChange && (
						<ProviderRoutingContainer>
							<ProviderRoutingLabel>提供方路由</ProviderRoutingLabel>
							<VSCodeDropdown
							...
							<p
								...
								{!providerSorting && "在多个提供方（AWS、Google Vertex 等）之间负载均衡，兼顾可用性并优先考虑价格"}
								{providerSorting === "price" && "按价格排序，优先选择成本最低的提供方"}
