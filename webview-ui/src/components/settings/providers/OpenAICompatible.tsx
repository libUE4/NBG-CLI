...
/**
 * The relay API provider configuration component.
 */
export const OpenAICompatibleProvider = ({ showModelOptions, isPopup, currentMode }: OpenAICompatibleProviderProps) => {
	...
	// Debounced function to refresh gateway models without excessive API calls while typing.
	...
	return (
		<div>
				...
				<TooltipTrigger>
					<div className="mb-2.5">
						<div className="flex items-center gap-2 mb-1">
							<span style={{ fontWeight: 500 }}>Relay 基础 URL</span>
			...
			<DebouncedTextField
				...
				placeholder={"claude-sonnet-4-6, gpt-5, kimi-for-coding..."}
				style={{ width: "100%", marginBottom: 10 }}>
				<span style={{ fontWeight: 500 }}>模型 ID</span>
			</DebouncedTextField>

			{/* Relay gateway headers */}
			{(() => {
							...
							<Tooltip>
								<TooltipTrigger>
									<div className="flex items-center gap-2">
										<span style={{ fontWeight: 500 }}>网关 Headers</span>
				...
				<>
					...
					<div style={{ display: "flex", gap: 10, marginTop: "5px" }}>
						<DebouncedTextField
							...
							style={{ flex: 1 }}>
							<span style={{ fontWeight: 500 }}>输入价格 / 100 万 Token</span>
						</DebouncedTextField>
						...
						<DebouncedTextField
							...
							style={{ flex: 1 }}>
							<span style={{ fontWeight: 500 }}>输出价格 / 100 万 Token</span>
						</DebouncedTextField>
					</div>
