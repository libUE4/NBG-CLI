		...
		<div className="mb-4">
			...
			<div className="bg-vscode-textBlockQuote-background rounded p-3 mb-2">
				...
				{remoteConfigSettings?.openTelemetryOtlpHeaders && (
					<SettingRow
						label="OTLP 请求头"
						value={`${Object.keys(remoteConfigSettings.openTelemetryOtlpHeaders).length} 个请求头`}
					/>
				)}
			...
			{otelEnabled && (
				<div className="flex gap-2 flex-wrap">
					<TestButton
						...
						successMessage="缓冲区已刷新！请查看输出通道获取更多详细信息。"
					/>
				</div>
			)}
		</div>
	...
	return (
		<div className="mb-4">
			...
			<div className="bg-vscode-textBlockQuote-background rounded p-3 mb-2">
				...
				{blobStoreConfig.accountId && <SettingRow label="账号 ID" value={blobStoreConfig.accountId} />}
		...
		return (
			<BaseRemoteConfigSection renderSectionHeader={renderSectionHeader}>
				<div className="flex flex-col justify-center gap-4">
					<h3>你已选择退出远程配置。重新启用后即可应用配置并在此查看。</h3>
