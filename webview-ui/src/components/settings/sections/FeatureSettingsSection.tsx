...
const experimentalFeatures: FeatureToggle[] = [
	{
		...
		label: "自动执行模式",
		description:
			"无需用户确认即可执行任务。会从规划模式自动切换到执行模式，并禁用提问工具。请极其谨慎使用。",
	...
	},
	{
		...
		label: "双重检查完成状态",
		description:
			"拒绝第一次完成尝试，并要求模型根据原始任务要求重新验证工作后再接受。",
		...
		<div className="mb-2">
			...
			<Section>
				<div className="mb-5 flex flex-col gap-3">
					...
					<div>
						<div className="text-xs font-medium uppercase tracking-wider mb-3 text-warning/80">实验功能</div>
						<div
