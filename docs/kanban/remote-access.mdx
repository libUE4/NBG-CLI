---
title: "Remote Access"
description: "通过 tunnels、VPNs 和 cloud services 从网络内其他设备或远程位置访问 Kanban"
---
...
```bash
KANBAN_RUNTIME_HOST=0.0.0.0 nbg
```

运行 `nbg` 时，Kanban 会绑定到 `0.0.0.0`。
...
export class KanbanEc2Stack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        userData.addCommands(
            ...
            // 1) Install cloudflared first for tunnel connectivity
            ...
            // 4) Install the Kanban launcher
            "sudo npm install -g kanban@latest",
