...
description: "Run NBG with local models using Ollama or LM Studio."
---

Run NBG with local inference on your machine.

## Quick Start

1. Install a local runtime (**Ollama** or **LM Studio**)
2. Start the local server
3. In NBG Settings, select the matching provider
4. Select a local model
5. Enable **Use Compact Prompt** in NBG Settings → Features
...
## Recommended NBG Settings for Local Inference
