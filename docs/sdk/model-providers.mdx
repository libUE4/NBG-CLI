...
description: "配置 provider credentials、model IDs 和 LLM gateway。"
---

`@cline/llms` package 提供 provider registries、model catalogs、handlers 和 gateway。`@cline/agents` 与 `@cline/core` 会在内部使用这一层。
