---
title: "Configure Anthropic in NBG (Members)"
...
<Tip>
API keys are stored locally and are only used by NBG.
</Tip>
...
Send a test message in NBG to verify your API key works correctly with the configured Anthropic endpoint.
