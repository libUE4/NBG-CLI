---
title: "Configure LiteLLM in NBG (Members)"
...
<Tip>
API keys are stored locally in VS Code and are only used by NBG.
</Tip>
</Accordion>
...
Send a test message in NBG to verify your connection works correctly with the LiteLLM proxy.
...
- Regularly update NBG for security patches
