---
title: "Configure OpenAI Compatible in NBG (Members)"
...
Send a test message in NBG to verify your credentials work correctly with the configured endpoint.
...
Confirm you're signed into the correct NBG organization. Verify your administrator has saved the configuration and that you have the latest version of NBG.
