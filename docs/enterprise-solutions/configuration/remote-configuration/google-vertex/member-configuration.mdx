---
title: "Configure Google Vertex AI in NBG (Members)"
...
**NBG installed and configured**

NBG must be installed in VS Code and you need to be signed into your organization account. If you haven't installed NBG yet, follow our [installation guide](/getting-started/installing-cline).

<Info>
**Quick Check**: Open the NBG panel in VS Code. If you see your organization name in the bottom left, you're signed in correctly.
</Info>
...
<Steps>
<Step title="Open NBG Settings">
Open VS Code and access the NBG settings panel using either of these methods:

- Click the settings icon (⚙️) in the NBG panel
...
4. NBG will use your default Google Cloud credentials automatically
</Accordion>
...
4. NBG will automatically detect credentials from your environment
</Accordion>
</AccordionGroup>
...
Send a test message in NBG to verify your credentials work correctly with the configured Vertex AI project and region.
