---
title: "NBG Telemetry"
sidebarTitle: "NBG Telemetry"
description: "Configure usage analytics and event tracking"
---

NBG includes telemetry to help understand usage patterns and improve the product. Users can control whether to share this data.

## What is NBG Telemetry?
...
### Enabling/Disabling NBG Telemetry

Individual users can control telemetry through NBG settings:

1. Open NBG settings
2. Find "NBG Telemetry" toggle
...
When telemetry is enabled, NBG captures:
...
<Note>
Even with enterprise configuration, individual users can still disable NBG Telemetry in their local settings.
</Note>

## Enterprise Monitoring Features

For organizations with additional compliance or monitoring requirements, NBG provides:
...
NBG telemetry is designed with privacy in mind:
