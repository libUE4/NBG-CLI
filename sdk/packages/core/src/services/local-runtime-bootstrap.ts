...
function buildProviderConfig(
	...
	if (!providerConfig.clientType && stored?.client) {
		providerConfig.clientType = stored.client;
	}
	if (!providerConfig.routingProviderId && stored?.routingProviderId) {
		providerConfig.routingProviderId = stored.routingProviderId;
	}
